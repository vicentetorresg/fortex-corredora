const features = [
  {
    ...
    description: "Evaluación técnica de los riesgos de su empresa para diseñar la cobertura óptima.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Negociamos con múltiples aseguradoras para obtener la mejor relación costo-beneficio.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Conocimiento profundo en construcción, transporte, retail, minería y más sectores.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Respaldo CMF",
    description: "Corredora regulada y fiscalizada por la Comisión para el Mercado Financiero.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Ejecutivo asignado para su cuenta con disponibilidad directa y respuesta oportuna.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Manejo estricto de información sensible bajo los más altos estándares de seguridad.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-lg text-navy-400">
            Nos distinguimos por un enfoque técnico, cercano y orientado a
